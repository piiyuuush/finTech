...
import { MoreHorizontal, Wallet, Edit2, Trash2, ArrowRightLeft, UserMinus, UserPlus, ArrowDownLeft, ArrowUpRight, Target } from 'lucide-react';
              ...
              >
                  <div className="flex justify-between items-start relative">
                     ...
                     <div className="flex items-center gap-2">
                        {acc.type === 'Cash' && <Wallet size={20} className="opacity-60" />}
                  ...
                  <div className="flex justify-between items-end">
                     <div>
                        <p className="text-[10px] opacity-60 font-mono tracking-widest mb-1 font-bold">
                          {acc.type === 'Cash' ? (acc.location || 'Physical Wallet') : (acc.cardNumber || '**** **** **** 0000')}
                        </p>
